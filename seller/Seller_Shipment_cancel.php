                ...
                <div class="row bg-white p-3">
                    <ul class="nav nav-pills d-flex justify-content-start">
                        ...
                        <li style="width: 200px;" class="nav-item">
                            <a class="nav-link active" aria-current="page" href="Seller_Shipment_cancel.php"><center>Cancellation<span class="shadow badge bg-secondary ms-3"><?php echo $cancelcount ?></span></center></a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <table id="example" class="display center" style="width: 100%; text-align: center;">
                ...
                <tbody>
                    <?php
                        ...
                        $query_tracking = mysqli_query($con,"SELECT * FROM tracking WHERE Tracking_Status ='cancel' AND FK_Tracking_Seller_ID = '$Seller_ID'");
                    ...
                    <tr>
                        ...
                        <td><?php echo $result_tracking['Tracking_Channel'] ?></td>
                            ...
                            <td><button class="btn btn-primary" type="submit" name="shipmentBtn"><i class="bi bi-truck"> </i> Delete Shipment</button></td>
                        </form>
                    </tr>
                    <?php
                        $shippingcount++;
...
<?php
    if(isset($_POST['shipmentBtn'])){
        ...
        //$query_updateTracking = mysqli_query($con,"UPDATE tracking SET Tracking_Status='completed' WHERE Tracking_ID = '$trackingID'");
        ...
        //$query_shipmentTracking = mysqli_query($con,"INSERT INTO tracking_shipment(Track_Ship_Status, Track_Ship_Date, Track_Ship_Time,FK_Tracking_ID)
         //VALUES ('completed','$todayDate','$todayTime','$trackingID')");

        echo '<script>window.location.href="Seller_Shipment_cancel.php?msg=success"</script>';
    }
?>
<!-- View Product list -->
