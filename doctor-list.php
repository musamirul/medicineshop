    ...
    <div class="col">
                ...
                <div class="p-2 bd-highlight"><center>
                    <form method="post" action="doctor-list.php">
                        <div style="width: 500px;" class="input-group mb-3">
                            <input class="form-control" type="text" name="doctorSearch" placeholder="Doctor's Specialty">
        ...
        <?php
            if(isset($_POST['searchButton'])){
                $doctorSearch = $_POST['doctorSearch'];
                $query_doctor = mysqli_query($con, "SELECT * FROM consultant_profile WHERE Consult_Profile_Speciality LIKE '%$doctorSearch%'");
