            ...
            <div class="col">
                <div class="row bg-white p-3">
                    <ul class="nav nav-pills d-flex justify-content-start">
                        ...
                        <li style="width: 170px;" class="nav-item">
                            <a class="nav-link active" aria-current="page" href="Admin_Consultation_Cancel.php"><center>Cancel<span class="shadow badge bg-secondary ms-3"><?php echo $cancelcount ?></span></center></a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <table id="example" class="display center" style="width: 100%; text-align: center;">
                ...
                <tbody>
                    <?php
                        ...
                        $query_showData = mysqli_query($con,"SELECT * FROM consult WHERE Consult_Status ='cancel'");
