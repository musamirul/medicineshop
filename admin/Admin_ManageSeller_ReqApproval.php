            ...
            <div class="col">
                <div class="row bg-white p-3">
                    <ul class="nav nav-pills d-flex justify-content-start">
                        ...
                        <li style="width: 170px;" class="nav-item">
                            <a class="nav-link <?php if($reqcount>0){echo 'bg-danger';}else{echo 'active';} ?>" href="Admin_ManageSeller_ReqApproval.php"><center><span class="<?php if($reqcount>0)echo 'text-white' ?>">Req. Approval</span><span class="shadow badge bg-secondary ms-3"><?php echo $reqcount ?></span></center></a>
                        </li>
                        <li style="width: 170px;" class="nav-item">
            ...
            <table id="example" class="display center" style="width: 100%; text-align: center;">
                ...
                <tbody>
                    <?php
                        ...
                        $query_showData = mysqli_query($con,"SELECT * FROM seller WHERE Seller_Registration_Status='reqApproval'");
...
<?php
    if(isset($_POST['saveDetail'])){
        ...
        echo '<script>window.location.href="Admin_ManageSeller_ReqApproval.php"</script>';
    }
?>
