...
<div class="row">
    <div class="col-12 bg-white shadow-sm p-3 mb-5 bg-body rounded me-5">
            ...
            <div class="col">
                <div class="row bg-white p-3">
                    <ul class="nav nav-pills d-flex justify-content-start">
                        ...
                        <li style="width: 170px;" class="nav-item">
                            <a class="nav-link active" aria-current="page" href="Admin_Consultation_Request.php"><center>Request<span class="shadow badge bg-secondary ms-3"><?php echo $activecount ?></span></center></a>
                        </li>
                        <li style="width: 170px;" class="nav-item">
        ...
        <?php }else{ ?>
        <div style="background-color: antiquewhite;" class="row p-2">
                <span style="font-size: 16px;font-weight: 600;">New requested consultation</span> <br/>
        </div>
        <?php } ?>
            ...
            <table id="example" class="display center" style="width: 100%; text-align: center; font-size:13px">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($result_showData['Consult_Status']=='complete'){
                                echo 'complete';
                            }elseif($result_showData['Consult_Status']=='cancel'){
                                echo 'cancel';
                            }else{?>
                            <form method="post">
                        ...
                        <td>
                            <input type="hidden" value="<?php echo $consult_id; ?>" name='saveconsult_id'>
                            <button class="btn btn-primary" type="submit" name="saveDetail" <?php if($result_showData['Consult_Status']=='complete' || $result_showData['Consult_Status']=='cancel'){echo 'disabled';} ?>>Update</button>
                            </form>
                        </td>
                    </tr>
        ...
        <div style="background-color: rgb(215, 248, 250);" class="row p-2">
            <span style="font-size: 16px;font-weight: 600;">Completed consultation</span> <br/>
        </div>
        <span class="d-grid mx-auto mb-3" style="border-bottom:0.5px solid rgb(241, 240, 240);"></span>
        <div class="row pt-2 ps-5 pe-5">
...
<?php
    if(isset($_POST['saveDetail'])){
        $status = $_POST['status'];
        $consult_ID = $_POST['saveconsult_id'];
        date_default_timezone_set("Asia/Kuala_Lumpur");
        $todayDate = date('d-m-Y');
        $todayTime = date('h:i:s a');
        $Admin_ID = $_SESSION['Admin_Id'];

        $query_updateConsult = mysqli_query($con,"UPDATE consult SET Consult_Status='$status',Consult_CompDate='$todayDate',`Consult_CompTime`='$todayTime',FK_Consult_Admin_ID='$Admin_ID' WHERE Consult_ID = '$consult_ID'");
