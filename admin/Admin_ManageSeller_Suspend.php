            ...
            <div class="col">
                <div class="row bg-white p-3">
                    <ul class="nav nav-pills d-flex justify-content-start">
                        ...
                        <li style="width: 170px;" class="nav-item">
                            <a class="nav-link active" href="Admin_ManageSeller_Suspend.php"><center>Suspend<span class="shadow badge bg-secondary ms-3"><?php echo $suspendcount ?></span></center></a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <table id="example" class="display center" style="width: 100%; text-align: center;">
                ...
                <tbody>
                    <?php
                        ...
                        $query_showData = mysqli_query($con,"SELECT * FROM seller WHERE Seller_Registration_Status='suspend'");
