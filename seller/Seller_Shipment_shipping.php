            ...
            <div class="col">
                <div class="row bg-white p-3">
                    <ul class="nav nav-pills d-flex justify-content-start">
                        ...
                        <li style="width: 150px;" class="nav-item">
                            <a class="nav-link active" aria-current="page" href="Seller_Shipment_shipping.php"><center>Shipping<span class="shadow badge bg-secondary ms-3"><?php echo $shippingcount ?></span></center></a>
                        </li>
                        <li style="width: 150px;" class="nav-item">
